...
<template>
    <div class="flex justify-between items-center flex-wrap sticky top-0 z-10 bg-slate-600 text-white md:justify-center lg:justify-between">
        <img src="../images/logo.png" alt="Rick and morty logo" class=" h-20 italic ml-[20px] sm:hidden md:hidden  lg:block">
        ...
        <ul class="flex p-[10px]">
            ...
            <li class=" px-10 text-xl"><RouterLink active-class="active" to="/locations">Locations</RouterLink></li>
        </ul>
    </div>
</template>
<style scoped>
